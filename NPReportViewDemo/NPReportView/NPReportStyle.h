...
// NPReportStyleSettings
extern NSString *const NPRHeightOfHeaderRowSettingName;
extern NSString *const NPRHeightOfRowSettingName;
extern NSString *const NPRWidthOfFirstColSettingName;
extern NSString *const NPRWidthOfColSettingName;
extern NSString *const NPRAutoFitHeightSettingName;
extern NSString *const NPRBackgroundColorSettingName;
extern NSString *const NPRBackgroundColorOfHeaderSettingName;
extern NSString *const NPRTextColorSettingName;
extern NSString *const NPRTextColorOfHeaderSettingName;
extern NSString *const NPRFontSettingName;
extern NSString *const NPRFontOfHeaderSettingName;
extern NSString *const NPRTextAlignmentSettingName;
extern NSString *const NPRTextAlignmentOfHeaderSettingName;
extern NSString *const NPRSpacingSettingName;
extern NSString *const NPRBorderColorSettingName;
extern NSString *const NPRBorderInsetsSettingName;
extern NSString *const NPRTrimWidthSpaceSettingName;
extern NSString *const NPRTrimHeightSpaceSettingName;
extern NSString *const NPRStripeBackgroundColorSettingName;
extern NSString *const NPRStripeTextColorSettingName;


/**
 *  NPReportStyle 对应报表整体的风格样式
 */
@interface NPReportStyle : NSObject
/**
